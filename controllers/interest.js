module.exports=function(async,Message,Users,FriendResult,aws,formidable){
    return {
        SetRouting:function(router){
            router.get('/settings/interest',this.profile);  
            router.post('/settings/interest',this.postProfile);
        ...
        profile:function(req,res){
            async.parallel([
                ...
                res.render('user/interest', { title: 'SocialService-Interest', chat:result2,data: result1, user: req.user });
            });
