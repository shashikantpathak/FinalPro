// module.exports=function(async,Message,Users,FriendResult,aws,formidable){
//     return {
//         SetRouting:function(router){
//             router.get('/settings/profile',this.profile);  
//             router.post('/userupload',aws.Upload.any(),this.userupload);
//             router.post('/settings/profile',this.postProfile);
//             router.get('/profile/:name',this.overView);
//             router.post('/profile/:name',this.overPostView);
//         },
...
//                 res.render('user/profile', { title: 'SocialService-Profile', chat:result2,data: result1, user: req.user });
//             });
...
//                 const result1 = results[0];
//                 const result2 = results[1];
//                 res.render('user/overview', { title: 'SocialService-OverView', chat:result2,data: result1, user: req.user });
//             });

//         },
//         overPostView:function(req,res){
